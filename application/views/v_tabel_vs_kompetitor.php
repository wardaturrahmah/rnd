			...
			var kode5=<?php echo $kode5;?>;
				...
				$.ajax({
					...
					success:function(data)
					{
							...
							//loop opsi
							for(i=0; i<obj.length; i++){
								html += '<option value="'+obj[i].id_kompetitor+'">'+obj[i].nama+'</option>';
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
						<div class="x_panel">
								...
								if($ke==0)
								{
									for($panelis_selected=1;$panelis_selected<=3;$panelis_selected++)
									{
										...
										<div style="overflow-x:auto;overflow-y:auto;height:350px;">
											...
											<tr>
											<?php
											$data=$this->Transaksi_model->nilai_kode_vs_kompetitor($item_selected,$panelis_selected,$komp1,$komp2,$kode1,$kode2,$kode3,$kode4,$kode5)->result();
											$var1='';
											$var2='';
											$panelis1='';
											$panelis2='';
							...
							<tr>
							<?php
							$data=$this->Transaksi_model->nilai_kode_vs_kompetitor2($item_selected,$panelis_selected,$komp1,$komp2,$kode1,$kode2,$kode3,$kode4,$kode5)->result();
							$var1='';
							$var2='';
							$subvar1='';
							$subvar2='';
