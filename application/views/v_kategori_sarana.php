<html lang="en">
	...
	<body class="nav-md" onload="get_op();">            
		<div class="right_col" role="main">
				...
				<?php if($this->session->flashdata('message_kategori_sarana')!='') 
						{
				?>
				<div class="page-title">
						...
						<strong><?php echo $this->session->flashdata('message_kategori_sarana')?></strong>
					</div>
				</div>
				<?php } 
							...
							<form class="form-horizontal form-label-left" action="<?php echo $form?>" method="post">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input name="kategori" type="text" class="form-control" value="<?php echo  isset($default['kategori']) ? $default['kategori'] : ''; ?>" onKeyUp="check_length('kategori',50)">
									</div>
								</div>
