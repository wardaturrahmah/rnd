<html lang="en">
	<head>
		<title>Laporan VS Kompetitor</title>
		<script>
			function get_kode(){
			var id_item=$( "#item option:selected" ).val();
			var komp1=<?php echo $komp1;?>;
			var komp2=<?php echo $komp2;?>;
			var komp3=<?php echo $komp3;?>;
			var komp4=<?php echo $komp4;?>;
			var komp5=<?php echo $komp5;?>;
			...
			var kode5=<?php echo $kode5;?>;
				...
				$.ajax({
					url:'<?php echo base_url();?>tabel/get_kompetitor',
					method:'post',
					data:{
							id_item:id_item,
						},
					success:function(data)
					{
							...
							for(i=0; i<obj.length; i++){
								...
								html2 += '<option value="'+obj[i].id_kompetitor+'">'+obj[i].nama+'</option>';
							}
							$('#komp1').html(html2);
							$('#komp2').html(html2);
							$('#komp3').html(html2);
		...
		<div class="right_col" role="main">
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Laporan VS Kompetitor: Laporan yang digunakan untuk memversuskan 5 formula pada produk dan 2 kompetitor</h2>
						...
						<div class="x_content">
							...
							<form class="form-horizontal form-label-left" action="<?php echo $form?>" method="post">
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Kompetitor 1</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select name="komp1" id="komp1" class="komp1 form-control" required>
											<option> - </option>
											<?php
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Kompetitor 2</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select name="komp2" id="komp2" class="komp2 form-control">
											<option> - </option>
											<?php
												echo ! empty($option) ? $option : '';
											?>
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Kompetitor 3</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select name="komp3" id="komp3" class="komp3 form-control">
											<option> - </option>
											<?php
												echo ! empty($option) ? $option : '';
											?>
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Kompetitor 4</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select name="komp4" id="komp4" class="komp4 form-control">
											<option> - </option>
											<?php
												echo ! empty($option) ? $option : '';
											?>
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Kompetitor 5</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select name="komp5" id="komp5" class="komp5 form-control">
											<option> - </option>
											<?php
												echo ! empty($option) ? $option : '';
											?>
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
						<div class="x_panel">
							...
							$hdk=$this->Transaksi_model->hdr_kode_vs_komp2($panelis_selected,$komp1,$komp2,$komp3,$komp4,$komp5)->result();
							$hdf=$this->Transaksi_model->hdr_kode_vs($panelis_selected,$kode1,$kode2,$kode3,$kode4,$kode5)->result();
								...
								if($ke==0)
								{
									for($panelis_selected=1;$panelis_selected<=3;$panelis_selected++)
									{
										...
										<div style="overflow-x:auto;overflow-y:auto;height:350px;">
											...
											{
											?>
												<th colspan="3"><center><?php echo $hd->nama.'<br>'.date('d-m-Y',strtotime($hd->tanggal));?></center></th>
											<?php
											...
											<tr>
											<?php
											$data=$this->Transaksi_model->nilai_kode_vs_kompetitor3($item_selected,$panelis_selected,$komp1,$komp2,$komp3,$komp4,$komp5,$kode1,$kode2,$kode3,$kode4,$kode5)->result();
											$var1='';
											$var2='';
											$panelis1='';
											$panelis2='';
											...
											<?php
												...
												foreach($hdk as $hd)
												{
													...
													{
														$nilai="<font color='white'>".$nilai2."</font>";
														$bgcolor="blue";
													}
							...
							<tr>
							<?php
							$data=$this->Transaksi_model->nilai_kode_vs_kompetitor4($item_selected,$panelis_selected,$komp1,$komp2,$komp3,$komp4,$komp5,$kode1,$kode2,$kode3,$kode4,$kode5)->result();
							$var1='';
							$var2='';
							$subvar1='';
							$subvar2='';
							...
							<?php
								...
								{
							?>
									<td rowspan="<?php echo $var[$dt->subvar]?>"><?php echo $dt->subvar; ?></td>
							<?php
								}
								$subvar1=$subvar2;
							?>
