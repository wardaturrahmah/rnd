	...
	<body class="nav-md">            
		<div class="right_col" role="main">
			<div class="title_left">
				...
				<?php if($this->session->flashdata('message_masalah')!='') 
						{
				?>
				<div class="page-title">
						...
						<strong><?php echo $this->session->flashdata('message_masalah')?></strong>
					</div>
				</div>
				<?php } 
				if($auth_menu->C==1)
							...
							<form class="form-horizontal form-label-left" action="<?php echo $form?>" method="post">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input name="masalah" type="text" class="form-control" value="<?php echo  isset($default['masalah']) ? $default['masalah'] : ''; ?>" onKeyUp="check_length('masalah',50)">
									</div>
								</div>
