		...
		<div class="right_col" role="main">
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Laporan Penilaian All : Laporan 3 panelis terakhir</h2>
				...
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							...
							{
							?>
								<th colspan="3"><center><u><a onclick="get_formula('<?php echo $hd->id_formula?>');"><?php echo $hd->kode.'<br>'.date('d-m-Y',strtotime($hd->tanggal));?></u></a></center></th>
							<?php
							...
							<tr>
							<?php
							$data=$this->Transaksi_model->nilai_lpa($items,$panelis_selected)->result();
							$var1='';
							$var2='';
							$panelis1='';
							$panelis2='';
							...
							?>
									<td rowspan="<?php echo $var[$dt->panelis]?>"><?php echo $dt->panelis.' '.$step; ?></td>
							<?php
								}
								$panelis1=$panelis2;
							?>
						...
						?>
							...
							<tr>
							<?php
							$data=$this->Transaksi_model->nilai_lpa2($items,$panelis_selected)->result();
							$var1='';
							$var2='';
							$subvar1='';
							$subvar2='';
							...
							<td><?php echo $dt->panelis.' '.$step; ?></td>
							<?php
								$nilai1=0;
								$nilai2=0;
								$k=0;
