<html lang="en">
	<head>
		<title>Laporan Harian Produk </title>
		...
		<div class="right_col" role="main">
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Laporan Harian Produk : Laporan yang menunjukkan banyak formula pada produk per hari</h2>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<?php
											foreach ($produk as $produk) {
												...
												?>
												<option <?php echo $str_flag ?> value="<?php echo $produk->id ?>">
				...
				<div class="col-md-12 col-xs-12">
						<div class="x_panel">
							...
							?>
								...
								$dt=$this->Transaksi_model->rekap_harian_produk2($produks,date("Y-m-d",strtotime($tgl_awal)),date("Y-m-d",strtotime($tgl_akhir)))->result();
								foreach($dt as $dt)
								{
								...
								$dt=$this->Transaksi_model->rekap_kontribusi_harian_produk2($produks,date("Y-m-d",strtotime($tgl_awal)),date("Y-m-d",strtotime($tgl_akhir)))->result();
								foreach($dt as $dt)
								{
