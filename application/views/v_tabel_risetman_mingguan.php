<html lang="en">
	<head>
		<title>Laporan Risetman Mingguan</title>
		<script>
		function get_produk(){
							...
							<form class="form-horizontal form-label-left" action="<?php echo $form?>" method="post">
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select class="form-control" name="risetman" id="risetman">
										<?php
											foreach ($risetman as $risetman) {
												?>
												<option <?php echo $risetman_selected == $risetman->risetman ? 'selected="selected"' : '' ?> value="<?php echo $risetman->risetman ?>">
						...
						<div class="x_panel">
							...
							?>
								...
								for($i=$week1+1;$i<=$week2+1;$i++)
								{
									$h++;
								?>
									<th><center><?php echo 'W. '.$h;?></center></th>
								<?php 
