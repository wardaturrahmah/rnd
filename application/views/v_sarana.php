<html lang="en">
	...
	<body class="nav-md">            
		<div class="right_col" role="main">
				...
				<?php if($this->session->flashdata('message_sarana')!='') 
						{
				?>
				<div class="page-title">
						...
						<strong><?php echo $this->session->flashdata('message_sarana')?></strong>
					</div>
				</div>
				<?php } 
				if($auth_menu->C==1)
						...
						<div class="x_content">
							...
							<form class="form-horizontal form-label-left" action="<?php echo $form?>" method="post">		
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Nama sarana</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input name="sarana" type="text" class="form-control" value="<?php echo  isset($default['sarana']) ? $default['sarana'] : ''; ?>" onKeyUp="check_length('sarana',50)">
									</div>
								</div>								
								<div class="form-group">
