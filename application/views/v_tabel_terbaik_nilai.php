<html lang="en">
	<head>
		<title>Laporan Nilai Terbaik</title>
		<script>
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
							<?php
							$num=$this->Transaksi_model->hdr_kode_terbaik(3,$item_selected)->num_rows();
							if($num>0)
							{
							...
							$hdr=$this->Transaksi_model->hdr_kode_terbaik($panelis_selected,$item_selected)->result();
							foreach($hdr as $hd)
							{
							?>
							...
							<tr>
							<?php
							$data=$this->Transaksi_model->nilai_kode_terbaik($item_selected,$panelis_selected)->result();
							$var1='';
							$var2='';
							$panelis1='';
							$panelis2='';
							...
							<tr>
							<?php
							$data=$this->Transaksi_model->nilai_kode_terbaik2($item_selected,$panelis_selected)->result();
							$var1='';
							$var2='';
							$subvar1='';
							$subvar2='';
