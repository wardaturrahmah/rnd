<html lang="en">
	<head>
		<title>Laporan Sumber Masalah</title>
		<script>
		function get_dtl(id)
		{
			var arr = id.split("_");
		...
		<div class="right_col" role="main">
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Laporan Sumber Masalah: Laporan persentase sumber masalah dan detail masalah</h2>
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
						<div class="x_panel">
							...
							<?php
							$num=$this->Transaksi_model->sumber_masalah($items,$ke,date('Y-m-d',strtotime($tgl_awal)),date('Y-m-d',strtotime($tgl_akhir)))->num_rows();
							$dt=$this->Transaksi_model->sumber_masalah($items,$ke,date('Y-m-d',strtotime($tgl_awal)),date('Y-m-d',strtotime($tgl_akhir)))->result();
							...
							<tr>
									<td width="25%">Total Formula dipanelis</td>
									<?php
									$tot=$this->Transaksi_model->formula_panelis($items,$ke)->num_rows();?>
									<td width="75%"><?php echo $tot;?></td>
							...
							<?php
								...
								?>
								<tr>
									<td><?php echo $dt->masalah?></td>
									<td><u><a onclick="get_dtl('<?php echo $items.'_'.$ke.'_'.$dt->id_masalah.'_'.$tgl_awal.'_'.$tgl_akhir;?>');"><?php echo $dt->jum.' ('.round($dt->jum/$tot*100).' %)'?></a></u></td>
								</tr>
								<?php
								}
								?>
