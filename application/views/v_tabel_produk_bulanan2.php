<html lang="en">
	<head>
		<title>Laporan Bulanan Produk</title>
		<script>
		...
		<div class="right_col" role="main">
			...
			<div class="row">	  
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Laporan Bulanan Produk : Laporan yang menunjukkan banyak formula pada produk per bulan</h2>
							...
							?>
								...
								foreach($hdr as $hd)
								{
									...
									$bulan = array("","Januari", "Februari", "Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember");
										...
										$id=$hd->tgl;
										$form="'#".$id."'";
										echo '<form action="tabel_produk_mingguan2" method="post" id="'.$id.'" target="_blank">';
